...
namespace SessionApp.Migrations
{
    ...
    [Migration("20260410030355_AddFeedbackTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionApp.Data.Entities.FeedbackEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionApp.Data.Entities.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SessionApp.Data.Entities.FeedbackEntity", b =>
                {
                    b.HasOne("SessionApp.Data.Entities.UserEntity", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SessionApp.Data.Entities.SessionEntity", b =>
                {
                    b.HasOne("SessionApp.Data.Entities.UserEntity", "HostUser")
                        .WithMany()
